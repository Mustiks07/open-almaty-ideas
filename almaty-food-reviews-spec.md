# Almaty Food Reviews — Техническое задание

## Общее описание

Платформа отзывов о ресторанах и кафе Алматы. Жители города оставляют отзывы о заведениях, оценивают еду, сервис и цену, голосуют за полезность отзывов. Владельцы заведений могут отвечать на отзывы через администратора.
...
```
Сид-данные (8 районов Алматы): Алмалы, Әуезов, Бостандық, Жетісу, Медеу, Наурызбай, Түрксіб, Алатау.
...
### Главная (Home/Index)
- Hero: тёмный градиент, заголовок "Almaty Food Reviews", подзаголовок
